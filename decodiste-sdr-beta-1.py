...
def spectrum():
        ...
        # graph_out = plt.subplot(212)
        # graph_out2 = plt.subplot(211)
        ...
        def animate(i):
            ...
            graph_out.psd(samples, NFFT=256, Fs=sdr.sample_rate /
             1e6, Fc=sdr.center_freq/1e6)

            
            
            graph_out2.specgram(samples,Fc=sdr.center_freq/1e6,  Fs=2)
            
            # samples2, NFFT=256, Fs=sdr.sample_rate /
            # 1e6, Fc=sdr.center_freq/1e6, detrend="linear"
